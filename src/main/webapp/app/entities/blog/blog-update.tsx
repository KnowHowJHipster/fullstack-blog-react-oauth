        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blogApp.blog.name')}
                id="blog-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('blogApp.blog.handle')}
                id="blog-handle"
                name="handle"
                data-cy="handle"
                type="text"
              ...
              />
              <ValidatedField id="blog-user" name="user" data-cy="user" label={translate('blogApp.blog.user')} type="select">
                <option value="" key="0" />
                {users
