...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'enact botch', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-03T07:13:57.218Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('netsuke yet');
      cy.get(`[data-cy="title"]`).should('have.value', 'netsuke yet');
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-03T03:21');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-03T03:21');
